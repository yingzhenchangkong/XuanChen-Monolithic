<template>
  <a-modal v-model:open="visible" title="分配员工" :width="1000">
    <template #footer>
      <a-button @click="handleCancel">关闭</a-button>
    </template>
    <a-row :gutter="20">
      <a-col :span="12">
        <a-table :dataSource="dataSourceUnAssignUsers" :columns="columnsAssignUser"
          :pagination="ipaginationUnAssignUsers" :loading="loadingUnAssignUsers"
