...
public class GenTableController {
    ...
    public Result listTableColumn(@RequestParam(name = "dataBaseId") String dataBaseId, @RequestParam(name = "tableName") String tableName) {
        GenTable genTable = genTableService.getOne(new QueryWrapper<GenTable>()
                .eq("database_id", dataBaseId)
                .eq("table_name", tableName));
        List<GenTableColumn> list = new ArrayList<>();
        if (genTable != null) {
            list = genTableColumnService.list(new QueryWrapper<GenTableColumn>()
                    .eq("table_id", genTable.getId()));
        }
    ...
    public Result listDBTable(GenDatabase genDatabase) {
     ...
     * @return
     */
    @GetMapping("/listDBTableColumn")
    public Result listDBTableColumn(GenDatabase genDatabase, @RequestParam(name = "tableName") String tableName) {
