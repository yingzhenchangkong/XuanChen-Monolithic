...
public class SysUserController {
    ...
    public Result add(@RequestBody SysUser sysUser) {
        ...
        sysUser.setPassword(authServiceCommon.encryptPassword(password));
        //保存密码
    ...
    public Result changePassword(HttpServletRequest request) throws IOException {
        ...
        String password = authServiceCommon.encryptPassword(passwordTemp);
        UpdateWrapper<SysUser> updateWrapper = new UpdateWrapper<>();
        updateWrapper.set("password", password)
    ...
    public Result importExcel(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
            ...
            for (SysUser sysUser : dataList) {
                ...
                String encodePassword = authServiceCommon.encryptPassword("XuanChen@888888");
