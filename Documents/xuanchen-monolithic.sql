...
CREATE TABLE `gen_table_column`  (
  ...
  `column_comment` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '列注释',
  `is_required` tinyint(1) NULL DEFAULT NULL COMMENT '是否必填字段',
  `is_edit` tinyint(1) NULL DEFAULT NULL COMMENT '是否编辑字段',
  `is_list` tinyint(1) NULL DEFAULT NULL COMMENT '是否列表字段',
  `is_query` tinyint(1) NULL DEFAULT NULL COMMENT '是否查询字段',
  `query_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '查询方式',
  `order_no` int NULL DEFAULT NULL COMMENT '排序码',
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '状态（1启用，0停用）',
  `del_flag` tinyint(1) NULL DEFAULT 0 COMMENT '删除状态（0正常，1已删除）',
  `create_by` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '创建人',
...
INSERT INTO `sys_dict` VALUES ('2024120993374179330', 'db_conn_type', '数据库连接类型', 5, 1, 0, 'admin', '2026-02-18 21:57:06', NULL, NULL);
...
INSERT INTO `sys_dict_item` VALUES ('2024121060386574337', 'db_conn_type', 'MySQL', 'mysql', 1, 1, 0, 'admin', '2026-02-18 21:57:22', NULL, NULL);
INSERT INTO `sys_dict_item` VALUES ('2024121170113761281', 'db_conn_type', 'Redis', 'redis', 2, 1, 0, 'admin', '2026-02-18 21:57:48', NULL, NULL);
